...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{../img/standard-cluster-images/ml-cluster1_history_server_job_summary.png}
  \caption{Resumen del job ML en Spark History Server (Cluster 1).}
  \label{fig:ml-cluster1-history}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{../img/standard-cluster-images/ml-cluster1_jobs_event_timeline.png}
  \caption{Timeline de eventos del job ML (Cluster 1).}
  \label{fig:ml-cluster1-timeline}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{../img/standard-cluster-images/ml-cluster1_stages_timing_breakdown.png}
  \caption{Desglose de tiempos por stage en el job ML (Cluster 1).}
  \label{fig:ml-cluster1-stages}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{../img/standard-cluster-images/ml-cluster1_executors_resource_utilization.png}
  \caption{Utilización de recursos de executors durante el job ML (Cluster 1).}
  \label{fig:ml-cluster1-executors}
\end{figure}
