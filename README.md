...
### 5. ML Model (PySpark en Dataproc)

**Objetivo**: Modelo de regresión supervisado para predicción de ventas

- Implementación de modelo de regresión lineal con PySpark MLlib
- Entrenamiento del modelo sobre Gold layer
- Evaluación del modelo con métricas: R², RMSE, MAE
- Comparación de performance entre configuraciones de cluster
- Exportación de predicciones a GCS/BigQuery
- Análisis de importancia de features

**Script**: `src/dataproc/ml_regression.py`
